...
public class NPClone {
	
	//https://gist.github.com/Vaquxine/a6338c991052e10dfe61
...
// 
//    public static HashMap<String, RemoteEntity> personal_clones = new HashMap<String, RemoteEntity>();
//    // Player_name, Time when npc was spawned -- used for npc despawn and npc respawn
// 
